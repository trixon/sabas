...
public class PkgmanBridge extends Bridge {

    public static final String PKGMAN = "pkgman";
    private final Map<String, String> mDefaultEnvironment = new HashMap<>();
    private final PkgmanPopulator mPopulator = new PkgmanPopulator();

    public PkgmanBridge() {
        super("PKGMAN", "5.4", "Haiku");
    }
    ...
    public String onGetVersion(Set<Process> processes) {
        return StringUtils.substringBefore(execute(List.of(PKGMAN, "--version"), processes), "\n\n");
    }

    @Override
    public BridgeOperation onProvideCacheClearCommand() {
        return BridgeOperation.ofProcess(List.of(PKGMAN, "clean", "expire-cache"),
                mDefaultEnvironment
        );
    }
    ...
    public BridgeOperation onProvideCacheUpdateCommand() {
        return BridgeOperation.ofProcess(List.of(PKGMAN, "refresh"),
                mDefaultEnvironment
        );
    }
    ...
    public BridgeOperation onProvideTransactionInstall(String... packages) {
        return BridgeOperation.ofProcess(List.of(PKGMAN,
                        "install",
    ...
    public BridgeOperation onProvideTransactionUpgrade() {
        return BridgeOperation.ofProcess(List.of(PKGMAN, "update"),
                mDefaultEnvironment
        );
    }
    ...
    public BridgeOperation onProvideVersionCommand() {
        return BridgeOperation.ofProcess(List.of(PKGMAN, "--version"),
                mDefaultEnvironment
        );
    }
